...
func TestSyncAccountPlanStaleEventSkipped(t *testing.T) {
	...
	if plan.PlanID != "individual:small:monthly:20260106" {
		t.Fatalf("plan after active event = %q, want individual:small:monthly:20260106", plan.PlanID)
	}
	...
	if plan.PlanID != "individual:small:monthly:20260106" {
		t.Errorf("stale cancel overwrote plan: got %q, want individual:small:monthly:20260106", plan.PlanID)
	}
}
