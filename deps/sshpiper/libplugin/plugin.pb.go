...
func (x *ConnMeta) GetLocalAddr() string {
	if x != nil {
		return x.LocalAddr
	}
	return ""
...
func (*AuthDenial) ProtoMessage() {}

func (x *AuthDenial) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthDenial.ProtoReflect.Descriptor instead.
func (*AuthDenial) Descriptor() ([]byte, []int) {
	return file_plugin_proto_rawDescGZIP(), []int{8}
}

func (x *AuthDenial) GetBanner() string {
	if x != nil {
		return x.Banner
	}
	return ""
...
func (x *AuthDenial) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
type NoneAuthResponse struct {
	...
	//
	//	*NoneAuthResponse_Upstream
	//	*NoneAuthResponse_Denial
	Result        isNoneAuthResponse_Result `protobuf_oneof:"result"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NoneAuthResponse) GetResult() isNoneAuthResponse_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *NoneAuthResponse) GetUpstream() *Upstream {
	if x != nil {
		if x, ok := x.Result.(*NoneAuthResponse_Upstream); ok {
			return x.Upstream
		}
	}
	return nil
...
func (x *NoneAuthResponse) GetDenial() *AuthDenial {
	if x != nil {
		if x, ok := x.Result.(*NoneAuthResponse_Denial); ok {
			return x.Denial
		}
	}
	return nil
...
type isNoneAuthResponse_Result interface {
	isNoneAuthResponse_Result()
}

type NoneAuthResponse_Upstream struct {
	Upstream *Upstream `protobuf:"bytes,1,opt,name=upstream,proto3,oneof"`
}

type NoneAuthResponse_Denial struct {
	Denial *AuthDenial `protobuf:"bytes,2,opt,name=denial,proto3,oneof"`
}

func (*NoneAuthResponse_Upstream) isNoneAuthResponse_Result() {}

func (*NoneAuthResponse_Denial) isNoneAuthResponse_Result() {}
...
type PasswordAuthResponse struct {
	...
	// Types that are valid to be assigned to Result:
	//
	//	*PasswordAuthResponse_Upstream
	//	*PasswordAuthResponse_Denial
	Result        isPasswordAuthResponse_Result `protobuf_oneof:"result"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PasswordAuthResponse) GetResult() isPasswordAuthResponse_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *PasswordAuthResponse) GetUpstream() *Upstream {
	if x != nil {
		if x, ok := x.Result.(*PasswordAuthResponse_Upstream); ok {
			return x.Upstream
		}
	}
	return nil
...
func (x *PasswordAuthResponse) GetDenial() *AuthDenial {
	if x != nil {
		if x, ok := x.Result.(*PasswordAuthResponse_Denial); ok {
			return x.Denial
		}
	}
	return nil
...
type isPasswordAuthResponse_Result interface {
	isPasswordAuthResponse_Result()
}

type PasswordAuthResponse_Upstream struct {
	Upstream *Upstream `protobuf:"bytes,1,opt,name=upstream,proto3,oneof"`
}

type PasswordAuthResponse_Denial struct {
	Denial *AuthDenial `protobuf:"bytes,2,opt,name=denial,proto3,oneof"`
}

func (*PasswordAuthResponse_Upstream) isPasswordAuthResponse_Result() {}

func (*PasswordAuthResponse_Denial) isPasswordAuthResponse_Result() {}
...
type PublicKeyAuthResponse struct {
	...
	// Types that are valid to be assigned to Result:
	//
	//	*PublicKeyAuthResponse_Upstream
	//	*PublicKeyAuthResponse_Denial
	Result        isPublicKeyAuthResponse_Result `protobuf_oneof:"result"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PublicKeyAuthResponse) GetResult() isPublicKeyAuthResponse_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *PublicKeyAuthResponse) GetUpstream() *Upstream {
	if x != nil {
		if x, ok := x.Result.(*PublicKeyAuthResponse_Upstream); ok {
			return x.Upstream
		}
	}
	return nil
...
func (x *PublicKeyAuthResponse) GetDenial() *AuthDenial {
	if x != nil {
		if x, ok := x.Result.(*PublicKeyAuthResponse_Denial); ok {
			return x.Denial
		}
	}
	return nil
...
type isPublicKeyAuthResponse_Result interface {
	isPublicKeyAuthResponse_Result()
}

type PublicKeyAuthResponse_Upstream struct {
	Upstream *Upstream `protobuf:"bytes,1,opt,name=upstream,proto3,oneof"`
}

type PublicKeyAuthResponse_Denial struct {
	Denial *AuthDenial `protobuf:"bytes,2,opt,name=denial,proto3,oneof"`
}

func (*PublicKeyAuthResponse_Upstream) isPublicKeyAuthResponse_Result() {}

func (*PublicKeyAuthResponse_Denial) isPublicKeyAuthResponse_Result() {}
...
type KeyboardInteractiveFinishRequest struct {
	...
	// Types that are valid to be assigned to Result:
	//
	//	*KeyboardInteractiveFinishRequest_Upstream
	//	*KeyboardInteractiveFinishRequest_Denial
	Result        isKeyboardInteractiveFinishRequest_Result `protobuf_oneof:"result"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *KeyboardInteractiveFinishRequest) GetResult() isKeyboardInteractiveFinishRequest_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *KeyboardInteractiveFinishRequest) GetUpstream() *Upstream {
	if x != nil {
		if x, ok := x.Result.(*KeyboardInteractiveFinishRequest_Upstream); ok {
			return x.Upstream
		}
	}
	return nil
...
func (x *KeyboardInteractiveFinishRequest) GetDenial() *AuthDenial {
	if x != nil {
		if x, ok := x.Result.(*KeyboardInteractiveFinishRequest_Denial); ok {
			return x.Denial
		}
	}
	return nil
...
type isKeyboardInteractiveFinishRequest_Result interface {
	isKeyboardInteractiveFinishRequest_Result()
}

type KeyboardInteractiveFinishRequest_Upstream struct {
	Upstream *Upstream `protobuf:"bytes,1,opt,name=upstream,proto3,oneof"`
}

type KeyboardInteractiveFinishRequest_Denial struct {
	Denial *AuthDenial `protobuf:"bytes,2,opt,name=denial,proto3,oneof"`
}

func (*KeyboardInteractiveFinishRequest_Upstream) isKeyboardInteractiveFinishRequest_Result() {}

func (*KeyboardInteractiveFinishRequest_Denial) isKeyboardInteractiveFinishRequest_Result() {}
...
const file_plugin_proto_rawDesc = "" +
	"\n" +
	"\fplugin.proto\x12\tlibplugin\"\xf8\x01\n" +
	"\bConnMeta\x12\x1b\n" +
	"\tuser_name\x18\x01 \x01(\tR\buserName\x12\x1b\n" +
	"\tfrom_addr\x18\x02 \x01(\tR\bfromAddr\x12\x17\n" +
	"\auniq_id\x18\x03 \x01(\tR\x06uniqId\x12=\n" +
	"\bmetadata\x18\x04 \x03(\v2!.libplugin.ConnMeta.MetadataEntryR\bmetadata\x12\x1d\n" +
	"\n" +
	"local_addr\x18\x05 \x01(\tR\tlocalAddr\x1a;\n" +
	...
	"\n" +
	"AuthDenial\x12\x16\n" +
	"\x06banner\x18\x01 \x01(\tR\x06banner\x12\x16\n" +
	...
	"\x04meta\x18\x01 \x01(\v2\x13.libplugin.ConnMetaR\x04meta\"\x80\x01\n" +
	"\x10NoneAuthResponse\x121\n" +
	"\bupstream\x18\x01 \x01(\v2\x13.libplugin.UpstreamH\x00R\bupstream\x12/\n" +
	"\x06denial\x18\x02 \x01(\v2\x15.libplugin.AuthDenialH\x00R\x06denialB\b\n" +
	"\x06result\"Z\n" +
	"\x13PasswordAuthRequest\x12'\n" +
	"\x04meta\x18\x01 \x01(\v2\x13.libplugin.ConnMetaR\x04meta\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\fR\bpassword\"\x84\x01\n" +
	"\x14PasswordAuthResponse\x121\n" +
	"\bupstream\x18\x01 \x01(\v2\x13.libplugin.UpstreamH\x00R\bupstream\x12/\n" +
	"\x06denial\x18\x02 \x01(\v2\x15.libplugin.AuthDenialH\x00R\x06denialB\b\n" +
	"\x06result\"^\n" +
	...
	"\n" +
	"public_key\x18\x02 \x01(\fR\tpublicKey\"\x85\x01\n" +
	"\x15PublicKeyAuthResponse\x121\n" +
	"\bupstream\x18\x01 \x01(\v2\x13.libplugin.UpstreamH\x00R\bupstream\x12/\n" +
	"\x06denial\x18\x02 \x01(\v2\x15.libplugin.AuthDenialH\x00R\x06denialB\b\n" +
	"\x06result\";\n" +
	...
	"\x04meta\x18\x01 \x01(\v2\x13.libplugin.ConnMetaR\x04meta\"\x90\x01\n" +
	" KeyboardInteractiveFinishRequest\x121\n" +
	"\bupstream\x18\x01 \x01(\v2\x13.libplugin.UpstreamH\x00R\bupstream\x12/\n" +
	"\x06denial\x18\x02 \x01(\v2\x15.libplugin.AuthDenialH\x00R\x06denialB\b\n" +
	"\x06result\"\xcd\x03\n" +
...
var file_plugin_proto_goTypes = []any{
	...
	(*AuthDenial)(nil),                                // 9: libplugin.AuthDenial
	(*StartLogRequest)(nil),                           // 10: libplugin.StartLogRequest
	(*Log)(nil),                                       // 11: libplugin.Log
	(*ListCallbackRequest)(nil),                       // 12: libplugin.ListCallbackRequest
	(*ListCallbackResponse)(nil),                      // 13: libplugin.ListCallbackResponse
	(*NewConnectionRequest)(nil),                      // 14: libplugin.NewConnectionRequest
	(*NewConnectionResponse)(nil),                     // 15: libplugin.NewConnectionResponse
...
var file_plugin_proto_depIdxs = []int32{
	...
	43, // 7: libplugin.UpstreamNextPluginAuth.meta:type_name -> libplugin.UpstreamNextPluginAuth.MetaEntry
	44, // 8: libplugin.UpstreamRetryCurrentPluginAuth.meta:type_name -> libplugin.UpstreamRetryCurrentPluginAuth.MetaEntry
	...
	9,  // 14: libplugin.NoneAuthResponse.denial:type_name -> libplugin.AuthDenial
	...
	9,  // 17: libplugin.PasswordAuthResponse.denial:type_name -> libplugin.AuthDenial
	...
	9,  // 20: libplugin.PublicKeyAuthResponse.denial:type_name -> libplugin.AuthDenial
	45, // 21: libplugin.KeyboardInteractivePromptRequest.questions:type_name -> libplugin.KeyboardInteractivePromptRequest.Question
	...
	9,  // 24: libplugin.KeyboardInteractiveFinishRequest.denial:type_name -> libplugin.AuthDenial
	25, // 25: libplugin.KeyboardInteractiveAuthMessage.prompt_request:type_name -> libplugin.KeyboardInteractivePromptRequest
	24, // 26: libplugin.KeyboardInteractiveAuthMessage.user_response:type_name -> libplugin.KeyboardInteractiveUserResponse
	26, // 27: libplugin.KeyboardInteractiveAuthMessage.meta_request:type_name -> libplugin.KeyboardInteractiveMetaRequest
	27, // 28: libplugin.KeyboardInteractiveAuthMessage.meta_response:type_name -> libplugin.KeyboardInteractiveMetaResponse
	28, // 29: libplugin.KeyboardInteractiveAuthMessage.finish_request:type_name -> libplugin.KeyboardInteractiveFinishRequest
	1,  // 30: libplugin.UpstreamAuthFailureNoticeRequest.meta:type_name -> libplugin.ConnMeta
	0,  // 31: libplugin.UpstreamAuthFailureNoticeRequest.allowed_methods:type_name -> libplugin.AuthMethod
	1,  // 32: libplugin.BannerRequest.meta:type_name -> libplugin.ConnMeta
	1,  // 33: libplugin.VerifyHostKeyRequest.meta:type_name -> libplugin.ConnMeta
	1,  // 34: libplugin.PipeStartNoticeRequest.meta:type_name -> libplugin.ConnMeta
	1,  // 35: libplugin.PipeErrorNoticeRequest.meta:type_name -> libplugin.ConnMeta
	10, // 36: libplugin.SshPiperPlugin.Logs:input_type -> libplugin.StartLogRequest
	12, // 37: libplugin.SshPiperPlugin.ListCallbacks:input_type -> libplugin.ListCallbackRequest
	14, // 38: libplugin.SshPiperPlugin.NewConnection:input_type -> libplugin.NewConnectionRequest
	16, // 39: libplugin.SshPiperPlugin.NextAuthMethods:input_type -> libplugin.NextAuthMethodsRequest
	18, // 40: libplugin.SshPiperPlugin.NoneAuth:input_type -> libplugin.NoneAuthRequest
	20, // 41: libplugin.SshPiperPlugin.PasswordAuth:input_type -> libplugin.PasswordAuthRequest
	22, // 42: libplugin.SshPiperPlugin.PublicKeyAuth:input_type -> libplugin.PublicKeyAuthRequest
	29, // 43: libplugin.SshPiperPlugin.KeyboardInteractiveAuth:input_type -> libplugin.KeyboardInteractiveAuthMessage
	30, // 44: libplugin.SshPiperPlugin.UpstreamAuthFailureNotice:input_type -> libplugin.UpstreamAuthFailureNoticeRequest
	32, // 45: libplugin.SshPiperPlugin.Banner:input_type -> libplugin.BannerRequest
	34, // 46: libplugin.SshPiperPlugin.VerifyHostKey:input_type -> libplugin.VerifyHostKeyRequest
	40, // 47: libplugin.SshPiperPlugin.PipeCreateErrorNotice:input_type -> libplugin.PipeCreateErrorNoticeRequest
	36, // 48: libplugin.SshPiperPlugin.PipeStartNotice:input_type -> libplugin.PipeStartNoticeRequest
	38, // 49: libplugin.SshPiperPlugin.PipeErrorNotice:input_type -> libplugin.PipeErrorNoticeRequest
	11, // 50: libplugin.SshPiperPlugin.Logs:output_type -> libplugin.Log
	13, // 51: libplugin.SshPiperPlugin.ListCallbacks:output_type -> libplugin.ListCallbackResponse
	15, // 52: libplugin.SshPiperPlugin.NewConnection:output_type -> libplugin.NewConnectionResponse
...
func file_plugin_proto_init() {
	...
	file_plugin_proto_msgTypes[18].OneofWrappers = []any{
		(*NoneAuthResponse_Upstream)(nil),
		(*NoneAuthResponse_Denial)(nil),
	}
	file_plugin_proto_msgTypes[20].OneofWrappers = []any{
		(*PasswordAuthResponse_Upstream)(nil),
		(*PasswordAuthResponse_Denial)(nil),
	}
	file_plugin_proto_msgTypes[22].OneofWrappers = []any{
		(*PublicKeyAuthResponse_Upstream)(nil),
		(*PublicKeyAuthResponse_Denial)(nil),
	}
	file_plugin_proto_msgTypes[27].OneofWrappers = []any{
		(*KeyboardInteractiveFinishRequest_Upstream)(nil),
		(*KeyboardInteractiveFinishRequest_Denial)(nil),
	}
