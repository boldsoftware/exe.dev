...
This commit is critical to the pipeline functioning: If we start out wrong, it is hard to recover. Wear your senior engineering hat: weigh alternative approaches, use your wisdom and judgment, resist scope creep, and don't overengineer.
