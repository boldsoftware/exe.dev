...
[ $TARGET ] || (echo "Usage: $0 <target-branch-for-both-repos> <subrepo> <subrepo_dir>"; exit 1)
[ $SUBREPO ] || (echo "Usage: $0 <target-branch-for-both-repos> <subrepo> <subrepo_dir>"; exit 1)
[ $SUBREPO_DIR ] || (echo "Usage: $0 <target-branch-for-both-repos> <subrepo> <subrepo_dir>"; exit 1)
