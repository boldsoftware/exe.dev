...
export const upgoer5: TranslationKeys = {
  ...
  failedToLoadConversations:
    "Could not get your talks. Please open this again.",
  ...
  osNotificationsWhenHidden:
    "Tell you things even when you can't see this",
  ...
  denied: "Said No",
  noServerChannelsConfigured:
    "No ways to hear from the far computer set up",
  addOne: "Add one",
  edit: "Change",
  ...
  noModelsConfiguredHint:
    "No brains set up yet. You need to add one to get started.",
