...
const file_exe_compute_v1_compute_proto_rawDesc = "" +
	...
	"\rawait_control\x18\x06 \x01(\v2\".exe.compute.v1.SendVMAwaitControlH\x00R\fawaitControlB\x06\n" +
	"\x04type\"\x89\x01\n" +
