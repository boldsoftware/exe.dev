...
const file_exe_proxy_v1_proxy_proto_rawDesc = "" +
	...
	"\bbox_name\x18\x03 \x01(\tR\aboxName2\xcc\x11\n" +
	...
	"\rCertForDomain\x12\".exe.proxy.v1.CertForDomainRequest\x1a#.exe.proxy.v1.CertForDomainResponse\x12y\n" +
	...
	"\x17IsBoxSharedWithUserTeam\x12,.exe.proxy.v1.IsBoxSharedWithUserTeamRequest\x1a-.exe.proxy.v1.IsBoxSharedWithUserTeamResponse\x12[\n" +
	...
	"\x13SSHKeyByFingerprint\x12(.exe.proxy.v1.SSHKeyByFingerprintRequest\x1a).exe.proxy.v1.SSHKeyByFingerprintResponse\x12X\n" +
