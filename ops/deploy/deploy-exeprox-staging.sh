#!/bin/bash
# Deploy script for exeprox binary
...
# Slack notification
DEPLOY_TS=$("$REPO_ROOT/scripts/deploy-notify.sh" start exeprox-staging "" "$INSTANCE_NAME")
cleanup_notify() {
...
echo "==========================================="
echo "Deploying exeprox to Staging"
echo "==========================================="
echo ""
...
if ! scp "ops/deploy/exeprox-staging.service" "$TAILSCALE_HOST:~/exeprox.service"; then
