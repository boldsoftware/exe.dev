...
# Slack notification
DEPLOY_TS=$("$REPO_ROOT/scripts/deploy-notify.sh" start exepipe "" "$INSTANCE_NAME")
cleanup_notify() {
...
echo "==========================================="
echo "Deploying exepipe to prod"
echo "==========================================="
echo ""
...
if ! scp "ops/deploy/exepipe-prod.service" "$TAILSCALE_HOST:~/exepipe.service"; then
