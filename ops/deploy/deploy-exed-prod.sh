...
if ! scp "ops/deploy/exed-prod.service" "$TAILSCALE_HOST:~/exed.service"; then
...
if ~/$BINARY_NAME --preflight --db /tmp/preflight.db --stage prod; then
