...
var allowedModels = map[Provider]map[string]ModelCost{
	...
	ProviderFireworks: {
		// Qwen models
		"accounts/fireworks/models/qwen3-coder-480b-a35b-instruct": {Input: 45, Output: 180},
		"accounts/fireworks/models/qwen3-235b-a22b":                {Input: 22, Output: 88},
		"accounts/fireworks/models/qwen3-8b":                       {Input: 5, Output: 20},
		...
		"accounts/fireworks/models/qwen3-vl-235b-a22b-thinking":    {Input: 22, Output: 88},
		"accounts/fireworks/models/qwen2p5-vl-32b-instruct":        {Input: 20, Output: 20},

		// GLM models
		"accounts/fireworks/models/glm-4p7":     {Input: 60, Output: 220},
		"accounts/fireworks/models/glm-4p6":     {Input: 55, Output: 219},
		"accounts/fireworks/models/glm-4p5":     {Input: 55, Output: 219},
		"accounts/fireworks/models/glm-4p5-air": {Input: 22, Output: 88},

		// Kimi models
		"accounts/fireworks/models/kimi-k2p5":             {Input: 60, Output: 300},
		"accounts/fireworks/models/kimi-k2-thinking":      {Input: 60, Output: 250},
		"accounts/fireworks/models/kimi-k2-instruct":      {Input: 100, Output: 300},
		"accounts/fireworks/models/kimi-k2-instruct-0905": {Input: 100, Output: 300},

		// DeepSeek models
		"accounts/fireworks/models/deepseek-v3p2":    {Input: 56, Output: 168},
		"accounts/fireworks/models/deepseek-v3p1":    {Input: 56, Output: 168},
		"accounts/fireworks/models/deepseek-v3-0324": {Input: 90, Output: 90},
		"accounts/fireworks/models/deepseek-r1-0528": {Input: 300, Output: 800},

		// MiniMax models
		"accounts/fireworks/models/minimax-m2":   {Input: 30, Output: 120},
		"accounts/fireworks/models/minimax-m2p1": {Input: 30, Output: 120},

		// GPT-OSS models
		"accounts/fireworks/models/gpt-oss-120b": {Input: 15, Output: 60},
		"accounts/fireworks/models/gpt-oss-20b":  {Input: 5, Output: 20},

		// Llama models
		"accounts/fireworks/models/llama-v3p3-70b-instruct":  {Input: 90, Output: 90},
		"accounts/fireworks/models/llama-v3p1-405b-instruct": {Input: 300, Output: 300},
		"accounts/fireworks/models/llama-v3p1-70b-instruct":  {Input: 90, Output: 90},
		"accounts/fireworks/models/llama-v3p1-8b-instruct":   {Input: 20, Output: 20},

		// Mixtral models
		"accounts/fireworks/models/mixtral-8x22b-instruct": {Input: 90, Output: 90},
