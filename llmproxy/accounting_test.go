...
func (m *mockAccountant) DebitUsage(ctx context.Context, debit UsageDebit) error {
	m.usageDebits = append(m.usageDebits, debit)
	return nil
}

// CreditUsage implements accountant.
func (m *mockAccountant) CreditUsage(ctx context.Context, credit UsageCredit) error {
