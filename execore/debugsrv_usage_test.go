...
func TestComputeUsageData(t *testing.T) {
	...
	metrics := []types.Metric{
		{Timestamp: now, VMName: "vm-a", DiskSizeBytes: 20e9, DiskLogicalUsedBytes: 5e9, CPUUsedCumulativeSecs: 100, CPUNominal: 2, NetworkTXBytes: 1000, NetworkRXBytes: 500, MemoryNominalBytes: 8e9, MemoryRSSBytes: 4e9},
		{Timestamp: now.Add(10 * time.Minute), VMName: "vm-a", DiskSizeBytes: 20e9, DiskLogicalUsedBytes: 6e9, CPUUsedCumulativeSecs: 220, CPUNominal: 2, NetworkTXBytes: 2000000, NetworkRXBytes: 1000000, MemoryNominalBytes: 8e9, MemoryRSSBytes: 5e9},
	}
	...
	if p.DiskUsedGB != 6.0 {
		t.Errorf("disk_used_gb: got %f, want 6.0", p.DiskUsedGB)
	}
