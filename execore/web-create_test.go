...
func TestIsCommandAllowed(t *testing.T) {
	...
	tests := []struct {
		...
		{"team role user@example.com admin", true},
		{"team role user@example.com user", true},
		{"team role user@example.com billing_owner", true},
		{"team transfer vm user@example.com", true},
